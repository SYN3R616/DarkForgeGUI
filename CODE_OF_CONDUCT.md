...
This Code of Conduct applies within all community spaces, and also applies when an individual is officially representing the community in public spaces. Examples of representing the community include posting in a mailing list, using an official email address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
...
**Consequence**: A warning with community impact guidelines.

### 2. Warning

**Community Impact**: A violation through a single incident or an upsetting element that is repeated.
...
**Consequence**: A temporary exclusion from interaction with the community for a specified period of time. No public or private interaction with the person for that time period, though
